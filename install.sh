...
SERVICE_TEMPLATE="$PROJECT_DIR/backend.service"
...
sudo cp "$PROJECT_DIR/default" /etc/nginx/sites-available/default
sudo systemctl restart nginx

# === Deploy HTML Frontend Files ===
echo "[7/8] Deploying frontend files..."
sudo cp "$PROJECT_DIR/index.html" /var/www/html/index.html
sudo cp "$PROJECT_DIR/history.html" /var/www/html/history.html
